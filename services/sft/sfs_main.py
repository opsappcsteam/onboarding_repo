...
def sfs_main(excel_path, app_name, env):
    sft_sheet = pd.read_excel(excel_path, 'SFS')
    ...
    onboarding_file_generation(app_name, 'SFS', 'Authorizer', sft_content_v1, '.json', 'v1')
    onboarding_file_generation(app_name, 'SFS', 'Authorizer', sft_content_v2, '.json', 'v2')
