...
def onboarding_file_generation(app_name, service, file_name, file_content, file_extension, version):
    ...
    if file_content != None:
        with open(f'./artifacts/onboarding/{app_name}-{service}_{file_file_name}{file_version}.txt', 'w') as file:
...
def reporting_file_generation(app_name, report_content):
    with open(f'./artifacts/reports/{app_name}-report.txt', 'w') as file:
